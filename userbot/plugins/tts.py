...
.tts Bir mesaja cevap olarak dil kodu
.tts Konuşulacak dil kodu metni"""
...
async def _(event):
    ...
    try:
        ...
        os.remove(required_file_name)
        await event.edit("İşlenmiş {} ({}) saniye {} içinde gerçekleşecektir!".format(text[0:97], lan, ms))
...
CMD_HELP.update({"tts": "**PLUGİN İSMİ:** `tts`\
      \n\n**📌Komut ➥ **`.tts Bir mesaja cevap olarak dil kodu` :\
      \n**Kullanım ➥ ** Konuşulacak Dil Kodu Metni."
                 })
